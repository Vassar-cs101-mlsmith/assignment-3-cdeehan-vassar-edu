...
(define BALL-AT-RIGHT
  (make-ball (circle (+ RADIUS 12) "solid" "red")
             (- WIDTH(+ RADIUS 12)) (/ HEIGHT 2) 7 10)) 

(define BALL-AT-TOP
  (make-ball (circle (+ RADIUS 2) "solid" "blue")
             (/ WIDTH 3) (+ RADIUS 2) 15 -12)) 

(define BALL-AT-BOTTOM 
  (make-ball (circle (+ RADIUS 25) "solid" "green")
             (/ WIDTH 5) (- HEIGHT (+ RADIUS 25)) 2 3)) 
...
(check-expect (ball-radius BALL-AT-BOTTOM) 50)
...
(define (top-edge? b)
  (cond
    ...
    [else #false]))
(check-expect (top-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (+ RADIUS 4) (/ HEIGHT 2) -6 7)) #false) 
(check-expect (top-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (+ RADIUS 4) (+ RADIUS 10) -6 7)) #true)
(check-expect (top-edge? (make-ball (circle (- RADIUS 5) "solid" "blue")
             (+ RADIUS 4) (+ RADIUS 10) -6 7)) #false)
...
(define (bottom-edge? b)
  (cond
    ...
    [else #false]))
(check-expect (bottom-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (+ RADIUS 4) (/ HEIGHT 2) -6 7)) #false)
(check-expect (bottom-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (+ RADIUS 4) (- HEIGHT (+ RADIUS 10)) -6 7)) #true)
(check-expect (bottom-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (+ RADIUS 4) (/ HEIGHT 2) -6 7)) #false)
...
(define (left-edge? b)
  (cond
    ...
    [else #false]))
(check-expect (left-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (+ RADIUS 10) (/ HEIGHT 2) -6 7)) #true)
(check-expect (left-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (+ RADIUS 12) (/ HEIGHT 2) -6 7)) #false) 
(check-expect (left-edge? (make-ball (circle (+ RADIUS 15) "solid" "blue")
             (+ RADIUS 12) (/ HEIGHT 2) -6 7)) #true) 
...
(define (right-edge? b)
  (cond
    ...
    [else #false]))
(check-expect (right-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (+ RADIUS 4) (/ HEIGHT 2) -6 7)) #false)
(check-expect (right-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (- WIDTH (+ RADIUS 10)) (/ HEIGHT 2) -6 7)) #true)
(check-expect (right-edge? (make-ball (circle (+ RADIUS 10) "solid" "blue")
             (/ WIDTH 2) (/ HEIGHT 2) -6 7)) #false)

; ball -> ball
; reverse ball's up-down direction   
(define (reverse-up-down b)
  (make-ball (ball-im b) (ball-x b) (ball-y b) (ball-dx b) (- (ball-dy b))))
(check-expect (reverse-up-down BALL-AT-LEFT) (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 4) (/ HEIGHT 2) -4 -4))
(check-expect (reverse-up-down BALL-AT-RIGHT) (make-ball (circle (+ RADIUS 12) "solid" "red")
             (- WIDTH(+ RADIUS 12)) (/ HEIGHT 2) 7 -10)) 
(check-expect (reverse-up-down BALL-AT-TOP) (make-ball (circle (+ RADIUS 2) "solid" "blue")
             (/ WIDTH 3) (+ RADIUS 2) 15 12))
(check-expect (reverse-up-down BALL-AT-BOTTOM) (make-ball (circle (+ RADIUS 25) "solid" "green")
             (/ WIDTH 5) (- HEIGHT (+ RADIUS 25)) 2 -3)) 
...
(check-expect (reverse-left-right BALL-AT-LEFT) (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 4) (/ HEIGHT 2) 4 4)) 
(check-expect (reverse-left-right BALL-AT-RIGHT) (make-ball (circle (+ RADIUS 12) "solid" "red")
             (- WIDTH(+ RADIUS 12)) (/ HEIGHT 2) -7 10))
(check-expect (reverse-left-right BALL-AT-TOP) (make-ball (circle (+ RADIUS 2) "solid" "blue")
             (/ WIDTH 3) (+ RADIUS 2) -15 -12))
(check-expect (reverse-left-right BALL-AT-BOTTOM) (make-ball (circle (+ RADIUS 25) "solid" "green")
             (/ WIDTH 5) (- HEIGHT (+ RADIUS 25)) -2 3))
...
(check-expect (move-ball BALL-AT-LEFT) (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ (+ RADIUS 4) -4) (+ (/ HEIGHT 2) 4) -4 4))
(check-expect (move-ball BALL-AT-TOP) (make-ball (circle (+ RADIUS 2) "solid" "blue")
             (+ (/ WIDTH 3) 15) (- RADIUS 10) 15 -12))
...
(check-expect (move-list-of-balls (list BALL-AT-LEFT BALL-AT-TOP))
     (list (make-ball (circle (+ RADIUS 4) "solid" "teal") (+ RADIUS 8) (+ (/ HEIGHT 2) 4)
                      4 4)
     (make-ball (circle (+ RADIUS 2) "solid" "blue")
             (+ (/ WIDTH 3) 15) (+ RADIUS 14) 15 12))) 
